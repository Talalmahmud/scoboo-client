        ...
        <div>
          ...
          <div className="mb-4">
            ...
            <div className="flex gap-2">
              {productData.colors.map((colorVariant) => (
                <button
                  key={colorVariant.colorName}
                  onClick={() => setSelectedColor(colorVariant)}
                  className={clsx(
                    "w-8 h-8 rounded-full border-2 border-gray-300 transition-all",
                  ...
                  style={{
                    background: `conic-gradient(${colorVariant.colorCode.join(
                      ","
                    )})`,
                  }}
                />
